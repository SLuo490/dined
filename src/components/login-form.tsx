          ...
          <form action={action}>
            <FieldGroup>
              {state?.error && (
                ...
                >
                  {/* Wrapping the icon in a div removes shadcn's absolute positioning */}
                  <div>
                    <AlertCircleIcon className="h-4 w-4" />
                  </div>
                  {/* Remove the default bottom margin on the title */}
            ...
            <FieldGroup>
              ...
              <Field>
                <Button type="submit" className="hover:bg-primary/80">
                  Login
                </Button>
