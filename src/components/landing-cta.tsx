...
export function LandingCta() {
  return (
    <section className="w-full max-w-5xl mx-auto px-4 sm:px-8">
      <div className="rounded-2xl bg-[oklch(0.99_0.01_75)] border border-border px-8 py-12 flex flex-col items-center gap-6 text-center">
        <h2 className="font-display text-2xl sm:text-3xl font-bold tracking-tight">
          Ready to start your food journal?
        </h2>
